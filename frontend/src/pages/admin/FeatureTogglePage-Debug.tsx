/**
 * ============================================
 * FEATURE TOGGLE ADMIN PAGE - DEBUG VERSION
 * ============================================
 */
...
export default function FeatureTogglePage() {
  ...
  // Debug logging
  useEffect(() => {
    console.log('🔍 Feature Toggle Debug Info:');
  ...
  const handleToggle = (featureId: string, currentEnabled: boolean) => {
    console.log('🔄 Toggling feature:', featureId, 'from', currentEnabled, 'to', !currentEnabled);
  ...
  if (isLoading) {
    return (
      <div className="flex items-center justify-center min-h-screen">
        ...
        <p className="ml-4">Loading features...</p>
      </div>
    );
  }
        ...
        {features.length === 0 && (
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-6">
            ...
            <p className="text-yellow-700 mt-2">
              The database appears to be empty. Please run the seeder script:
            </p>
