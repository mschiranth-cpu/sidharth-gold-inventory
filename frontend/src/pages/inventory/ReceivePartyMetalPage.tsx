...
export default function ReceivePartyMetalPage() {
  ...
  return (
    <div className="p-6">
      <div className="max-w-4xl mx-auto">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Receive Party Metal</h1>
          <p className="text-gray-600">Record metal received from customer/party</p>
        </div>
