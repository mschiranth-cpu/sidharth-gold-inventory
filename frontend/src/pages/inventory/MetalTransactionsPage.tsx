    ...
    <div className="py-4 sm:py-6 bg-gradient-to-b from-pearl to-white min-h-screen">
      ...
      {bulkDeleteOpen && (
        <BulkDeleteModal
          ...
          deleteFn={deleteMetalTransaction}
          describeRow={(t: any) => t.referenceNumber ?? t.id.slice(0, 8)}
          describeTypeLabel={(t: any) =>
      ...
      {bulkSettleOpen && (
        <BulkSettleModal
          ...
          settleFn={settleMetalPayment}
          describeRow={(t: any) => `${t.metalType} ${t.purity}K`}
