    ...
    <div className="py-4 sm:py-6 bg-gradient-to-b from-pearl to-white min-h-screen">
        ...
        <div className="sticky top-0 z-30 -mx-4 sm:-mx-6 lg:-mx-8 px-4 sm:px-6 lg:px-8 py-3 mb-4 bg-pearl/85 backdrop-blur-md border-b border-champagne-100/60">
          <div className="flex items-center justify-between flex-wrap gap-3">
            ...
            <div className="flex items-center gap-2 flex-wrap">
              ...
              <Link to="/app/inventory/stone-packets" aria-label="Back to Stone Packet Inventory dashboard">
                <Button variant="secondary">
      ...
      {bulkDeleteOpen && (
        <BulkDeleteModal
          ...
          deleteFn={deleteStonePacketTransaction}
      ...
      {bulkSettleOpen && (
        <BulkSettleModal
          ...
          settleFn={settleStonePacketPayment}
          describeRow={(t) =>
            [t.packet?.stoneType, t.packet?.color, t.packet?.quality]
              .filter(Boolean)
              .join(' · ') || (t.packet?.packetNumber ?? '—')
          }
